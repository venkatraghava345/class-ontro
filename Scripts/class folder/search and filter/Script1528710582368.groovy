...
WebUI.click(findTestObject('Page_Ontro/span_Classes'))
...
WebUI.click(findTestObject('Page_Ontro/span_A_Onetime.'))
...
WebUI.click(findTestObject('Page_Ontro/span_C_Two Months'))
...
WebUI.setText(findTestObject('Page_Ontro/input_form-control'), 'bala')

WebUI.sendKeys(findTestObject('Page_Ontro/input_form-control'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Page_Ontro/span_Toggle Dropdown'))

WebUI.click(findTestObject('Page_Ontro/button_Delete'))

WebUI.click(findTestObject('Page_Ontro/button_OK'))
